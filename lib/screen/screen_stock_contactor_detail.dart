...
import 'package:inapos/screen/screen_stock_contactor_detail_add.dart';
...
class ScreenStockInputContactorDetail extends StatefulWidget {
  // const ScreenStockInputContactorDetail({ Key? key }) : super(key: key);

  @override
  _ScreenStockInputContactorDetailState createState() =>
      _ScreenStockInputContactorDetailState();
}

class _ScreenStockInputContactorDetailState
    extends State<ScreenStockInputContactorDetail> {
  ...
  Future<Null> readallstockoutput() async {
    ...
    print('status = $status');
    String url = '${MyConstant().urlStockTranInCheck}';
    await Dio().get(url).then((value) {
      setState(() {
        loadstatus = false;
      });
      print('${MyConstant().urlStockTranInCheck} ${value.toString()}');
                ...
                child: FloatingActionButton.extended(
                  onPressed: () {
                    MaterialPageRoute route = MaterialPageRoute(
                        builder: (context) => ScreenStockInConDetaAdd());
  ...
  onSearchTextChanged(String text) async {
    ...
    stockOutputmodels.forEach((station) {
      if (station.teaminsTall.contains(text) ||
          ...
          station.dATEdetail.contains(text) ||
