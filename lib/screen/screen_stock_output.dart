...
class ScreenStockOutput extends StatefulWidget {
  // const ScreenStockOutput({ Key? key }) : super(key: key);

  @override
  _ScreenStockOutputState createState() => _ScreenStockOutputState();
}

class _ScreenStockOutputState extends State<ScreenStockOutput> {
  ...
  String inV = "OUC-${DateTime.now().toUtc().millisecondsSinceEpoch}";

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Mystyle().sarabuntext('จ่ายของผู้รับเหมา'),
      ),
          ...
          Row(
            ...
            children: <Widget>[
              TextButton.icon(
                ...
                onPressed: () async {
                  String url = '${MyConstant().urlStockTranOut}';
                  await Dio().post(url, data: {
                    "tf_inV": inV,
                    "tf_teamInstall": teamInstall,
                    "tf_date": selectedDate.toString().split(' ')[0],
                    "tf_opPOS": opPOS,
                    "tf_opPrinter": opPrinter,
                    "tf_opKeyboardMouse": opKeyboardMouse,
                    "tf_opScanner": opScanner,
                    "tf_opUps": opUps,
                    "tf_opEDCCable": opEDCCable,
                    "tf_oplan1m": oplan1m,
                    "tf_opstainlesssteelpole": opstainlesssteelpole,
                    "tf_opattenna2m": opattenna2m,
                    "tf_opattenna3m": opattenna3m,
                    "tf_oppg11": oppg11,
                    "tf_opsuargeGuard": opsuargeGuard,
                    "tf_opPaperPrint": opPaperPrint,
                    "tf_opFCC": opFCC,
                    "tf_opPowerFcc": opPowerFcc,
                    "tf_opPowerCL": opPowerCL,
                    "tf_opLOOP": opLOOP,
                    "tf_opP2P": opP2P,
                    "tf_opKiosPos": opKiosPos,
                    "tf_opKiosFleet": opKiosFleet,
                    "tf_opMiniPc": opMiniPc,
                    "tf_opFTD": opFTD,
                    "tf_opPad": opPad,
                    "tf_opFlScanner": opFlScanner,
                    "tf_opHub8": opHub8,
                    "tf_opHub16": opHub16,
                    "tf_opOrdering": opOrdering,
                    "tf_opLL": opLL,
                    "tf_opLR": opLR,
                    "tf_opEYS": opEYS,
                    "tf_opEYK": opEYK,
                    "tf_opUnion": opUnion,
                    "tf_opRubberBlock": opRubberBlock,
                    "tf_opSocket": opSocket,
                    "tf_opPuk": opPuk,
                    "tf_opClamp": opClamp,
                    "tf_opC": opC,
                    "tf_opCompound": opCompound,
                    "tf_opFiber": opFiber,
                    "tf_opALLOY": opALLOY,
                    "emp_name": userName
                  }).then(
